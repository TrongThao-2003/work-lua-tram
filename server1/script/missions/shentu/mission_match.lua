-- description	: Hµm nµy ch¹y khi OpenMission(Index)
-- author		: Roxone
-- datetime		: 2025-09-27
...
function start_signup()
    ...
    szMsg = format("ChiÕn tr­êng sinh tö ®· b¾t ®Çu råi, h·y gÆp Javan ®Ö tø t¹i map Ba L¨ng HuyÖn(202/197)  ®Ó b¸o danh. Thêi gian b¸o danh lµ %d phót", TIME_SIGNUP)
